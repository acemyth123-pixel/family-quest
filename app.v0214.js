...
async function getPushRegistration(){if(!pushSupported())return null;return navigator.serviceWorker.register('./sw.js?v=0213',{updateViaCache:'none'}).then(reg=>{reg.update().catch(()=>{});return reg})}
