 ...
 <div class="grid cards-3" style="margin-top:16px">
   ${state.users.map(u=>{
      ...
      return `<div class="card">
        ...
        ${u.name===state.currentUser?'<div class="action-row"><button class="ghost" data-action="profile-open">Customize Profile</button><button class="ghost" type="button" data-auth-action="signout">↪ Sign Out</button></div>':''}
      </div>`;
   }).join('')}
 </div>`;
}
